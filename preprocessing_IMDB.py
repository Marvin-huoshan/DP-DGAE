...
def mask_test_edges(adj):
    ...
    torch.save(obj=adj_train, f='pred_matrix/IMDB_adj_train.pth')
    torch.save(obj=train_edges, f='pred_matrix/IMDB_train_edges.pth')
    torch.save(obj=val_edges, f='pred_matrix/IMDB_val_edges.pth')
    torch.save(obj=val_edges_false, f='pred_matrix/IMDB_val_edges_false.pth')
    torch.save(obj=test_edges, f='pred_matrix/IMDB_test_edges.pth')
    torch.save(obj=test_edges_false, f='pred_matrix/IMDB_test_edges_false.pth')
